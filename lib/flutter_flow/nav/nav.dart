...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? ForumHomeWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: ForumHomeWidget.routeName,
          path: ForumHomeWidget.routePath,
          builder: (context, params) => ForumHomeWidget(),
        ),
        FFRoute(
